...
def tweet_search(api, querys, max_tweets, max_id, since_id, geocode):
    ...
    while len(searched_tweets) < max_tweets:
        ...
        try:
            new_tweets = api.search(q=querys, count=remaining_tweets,
...
def dist_search(Regione, search_phrases, min_days_old, max_days_old):
