...
pop_dict['Sinistra'] = {}
pop_dict['M5S'] = {}
Collegi_list = loadCOLLlist('SenatoPlur/LIST_CAMERA_PLUR_2017.csv')
search_groups_list = ['Destra', 'Sinistra', 'M5S']

cur_dir = os.getcwd()
dir_string = cur_dir + '/' +'SenatoPlur'
os.chdir(dir_string)
...
for Collegio in Exact_Collegi_list:
    ...
    print('\n')
map = '/home/antoniolopardo/Desktop/myRNN/mySentRNN_v0.02/SenatoPlur/LOWER_SENATO_PLUR_2017.geojson'
